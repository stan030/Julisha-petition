...
function showSuccessScreen(totalVotes) {
    ...
    const shareMessage = encodeURIComponent(
        `I just signed the Julisha Petition calling for accountability! ✊\n\n` +
        `${totalVotes.toLocaleString()} Kenyans have spoken. Join us: [YOUR_DOMAIN_HERE]\n\n` +
        `#JulishaPetition #Kenya2026 #Article257`
    );
